...
$cores = [
	...
	'navbar-light navbar-lightblue'
];
defined('NOME_SISTEMA')      || define('NOME_SISTEMA', 'ANTBUS'); //criar uma imagem com o mesmo nome do projeto para ser o logo
defined('PREFIXO_TB')      || define('PREFIXO_TB', 'antbus_');
defined('COR_NAVBAR')      || define('COR_NAVBAR', 'navbar-light navbar-lightblue');
defined('LOGO_SISTEMA')      || define('LOGO_SISTEMA', 'antwort.ico');
defined('BARRA_NAVEGACAO')      || define('BARRA_NAVEGACAO', 'T'); //T = TOP, L=LEFT