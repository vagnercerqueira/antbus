	...
	<div class="form_crud_modal">
		...
		<div class="row">
			<div class="col-md-3">
				...
				<input type="text" id="NOME" pattern="[a-zA-Z][a-zA-Z0-9\s]*" title="Nome e sobrenome" name="NOME" class=" form-control-sm form-control" required maxlength="50">
			</div>
			<div class="col-md-2">
		...
		<div class="row">
			<div class="col-xs-6 col-md-3" style="color:red">
				<label for="">&nbsp;</label>
				<div><small>Senha Gerada é o login do usuario</small></div>
			</div>
		</div>
