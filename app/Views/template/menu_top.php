		...
		<nav class="main-header navbar navbar-expand-md <?php echo COR_NAVBAR; ?>">
			<div class="container-fluid">
				<a href="javascript:;" class="navbar-brand">
					<img src="<?php echo base_url('assets/img/empresa/' .  LOGO_SISTEMA); ?>" alt="<?php echo  NOME_SISTEMA; ?>" class="brand-image img-circle elevation-2">
				...
				<div class="collapse navbar-collapse order-3" id="navbarCollapse">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a data-toggle="tooltip" title="Home" href="<?php echo base_url("home/" .  session()->get('home')); ?>" class="nav-link" style="color: floralwhite;"><i class="fa fa-home" aria-hidden="true"></i></a>
						</li>
